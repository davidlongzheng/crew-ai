...
TASK_DEFS = [
    ("1T 7p with(t)", "I will win 7p with a trump.", 3),
    (
        "1T #rank(>6)=0 #t=0",
        "I will win a trick of which the card values are all less than 7. Trumps are not allowed in the trick.",
        3,
    ),
    (
        "1T #p=#b #p>0",
    ...
    (
        "1T sum>28 #t=0",
        "I will win a trick with a total value greater than 28. Trumps are not allowed in the trick.",
        3,
    ),
    (
        "1T sum<12 #t=0",
        "I will win a trick with a total value less than 12. Trumps are not allowed in the trick.",
        3,
    ),
    (
        "1T sum>=22 sum<=23 #t=0",
        "I will win a trick with a total value of 22 or 23. Trumps are not allowed in the trick.",
        3,
    ),
    ...
    ("1T 9g with(t)", "I will the 9g with a trump.", 3),
    ("T0 T-1", "I will win the first and the last trick.", 4),
    # (
    #     "#T<#T(capt)",
    ...
    ("#T>#T(sumothers)", "I will win more tricks than everyone else combined.", 4),
    ("#t=0", "I will win no trumps.", 1),
    # (
    #     "#T=#T(capt)",
    ...
    ("#p>=5", "I will win at least 5 pinks.", 3),
    ("#t=2", "I will win exactly 2 trumps.", 3),
    ("consec(2) #T=2", "I will win exactly 2 tricks and they will be in a row.", 3),
    ("#t=3", "I will win exactly 3 trumps.", 4),
    ...
    ("#T=0", "I will win 0 tricks.", 3),
    ("no(T0) no(T1) no(T2)", "I will win none of the first 3 tricks.", 2),
    ("2t #t=1", "I will win 2t and no other trump.", 3),
    ...
    ("#t=1", "I will win exactly 1 trump.", 3),
    ("#p=0", "I will win no pinks.", 2),
    ("1t #t=1", "I will win 1t and no other trump.", 3),
    ...
    ("#y>#b", "I will win more yellow than blue cards. 0 blue cards is allowed", 1),
    ("#g=0", "I will win no greens.", 2),
    ("#y=0", "I will win no yellows.", 2),
    ("#1=0 #2=0 #3=0", "I will win no 1, 2, or 3's.", 3),
...
MED_TASK_DEFS = [
    ...
    ("no(T0) no(T1) no(T2) no(T3) no(T4)", "I will win none of the first 5 tricks.", 3),
    ("#y>#b", "I will win more yellow than blue cards. 0 blue cards is allowed.", 1),
    ("#g=0", "I will win no greens.", 2),
    ("#y=0", "I will win no yellows.", 2),
    ("nolead(p,g)", "I will not open with a pink or green.", 1),
